...
class TestMissionStorage(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self):
        ...
        patch2 = unittest.mock.patch.object(
            ConversationMissionManager, "get_conversation_mission", side_effect=mock_get_conversation_mission
        )
        ...
        patch3 = unittest.mock.patch.object(
            ConversationMissionManager, "get_conversation_role", side_effect=mock_get_conversation_role
        )
