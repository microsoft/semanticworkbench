...
class CoordinatorSupport:
    ...
    async def get_coordinator_next_action_suggestion(
        ...
        try:
            ...
            if not brief:
                return "Your knowledge share-out needs a short introduction that will orient your team. Let's write a knowledge brief next. The knowledge brief helps your team understand the purpose of this knowledge transfer and will be visible to all team members in their side panel."
            ...
            if TransferManager.is_ready_for_transfer(share) and not TransferManager.is_actively_sharing(share):
                return "Your knowledge is ready to share. Would you like to create a message and generate the invitation link?"
            ...
            if TransferManager.is_actively_sharing(share):
                if share.is_intended_to_accomplish_outcomes and not TransferManager._is_transfer_complete(share):
                    ...
                    return f"Great! Your knowledge is being shared with {team_count} team member{'s' if team_count != 1 else ''}. You can continue improving the knowledge share or respond to information requests as they come in."
                else:
                    return "Your knowledge transfer is in progress. You can continue improving the knowledge share or respond to information requests as they come in."

            # 9. Default: General support
            return "Your knowledge share is available. You can continue improving it or respond to new information requests as they come in."
