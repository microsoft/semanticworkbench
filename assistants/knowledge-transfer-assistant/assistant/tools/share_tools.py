"""
Main ShareTools class for Knowledge Transfer Assistant.
...
from .project_setup import ProjectSetupTools
...
class ShareTools:
    ...
    def _register_coordinator_tools(self):
        ...
        self.tool_functions.add_function(
            self.project_setup.set_knowledge_organized,
            "set_knowledge_organized",
        )

        # 2. Brief creation phase
        self.tool_functions.add_function(
            self.project_setup.update_brief,
            "update_brief",
        )

        # 3. Learning objectives phase
        self.tool_functions.add_function(
            self.project_setup.set_learning_intention,
