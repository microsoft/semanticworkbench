...
class AssistantRegistry:
    ...
    service. Each conversation has its own assistant and we start each assistant
    in its own thread so that all events are able to be asynchronously passed on
    to the Semantic Workbench.
    """
