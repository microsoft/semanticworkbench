...
from .config import OpenAIContentSafetyEvaluatorConfig, OpenAIServiceConfigModel
...
class OpenAIContentSafetyEvaluator(ContentSafetyEvaluator):
    ...
    def __init__(self, config: OpenAIContentSafetyEvaluatorConfig, config_secrets: OpenAIServiceConfigModel) -> None:
        self.config = config
