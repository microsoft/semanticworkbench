...
class IfExistsBehavior(StrEnum):
    FAIL = "fail"
    OVERWRITE = "overwrite"
...
class DriveConfig(BaseModel):
    root: str | PathLike
    default_if_exists_behavior: IfExistsBehavior = IfExistsBehavior.AUTO_RENAME
...
class Drive:
    ...
    def write(
        ...
        filename: str,
        dir: str | None = None,
        if_exists: IfExistsBehavior | None = None,
    ) -> FileMetadata:
        ...
        if self.file_exists(filename, dir):
            ...
            if if_exists == IfExistsBehavior.AUTO_RENAME:
                filename = self._unique_filename(filename, dir)
            elif if_exists == IfExistsBehavior.FAIL:
    ...
    def write_model(
        ...
        if_exists: IfExistsBehavior = IfExistsBehavior.AUTO_RENAME,
    ) -> None:
