...
async def write_client_resource(
    ...
    if content_type.startswith("text/"):
        content = TextResourceContents(uri=uri, mimeType=content_type, text=content.decode("utf-8"))
    else:
        content = BlobResourceContents(uri=uri, mimeType=content_type, blob=base64.b64encode(content).decode("utf-8"))
